...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light p-0">
        ...
        <div class="svg-box">
            <a href="/" class="header__logo">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 273 88">
                    <defs>
                        <style>
                            .cls-1 {
                                fill: #fff;
        ...
        <button class="navbar-toggler mr-2" type="button" data-toggle="collapse"
            data-target="#navbarSupportedContent-first" aria-controls="navbarSupportedContent-first"
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle p-3" href="#" id="navbarDropdown" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        RESOURCES
                    </a>
                    <ul class="nav__menu nav-dropdown__menu dropdown-menu" aria-labelledby="navbarDropdown">
                        <li class="nav__menu-item">
                            <a href="https://portal.apps.upenn.edu/penn_portal/student.php"
                                class="nav__menu-link">Current Students</a>
                        </li>
                        <li class="nav__menu-item">
                            <a href="https://portal.apps.upenn.edu/penn_portal/u@penn.php"
                                class="nav__menu-link">Faculty &amp; Staff</a>
                        </li>
                        <li class="nav__menu-item">
                        ...
                        <li class="nav__menu-item">
                            <a href="/penn-a-z" class="nav__menu-link">A-Z</a>
                        </li>
                        <li class="nav__menu-item">
                            <a href="/directories" class="nav__menu-link">Directory</a>
                        </li>
                        <li class="nav__menu-item">
                            <a href="https://provider.www.upenn.edu/computing/webmail/index.php"
                                class="nav__menu-link">Webmail</a>
                        </li>
                        <li class="nav__menu-item">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent-first">
            <ul class="navbar-nav align-items-center">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li class="dropdown-item">
                            <a href="/academics/undergraduate" class="nav__menu-link dropdown-item"
                                role="menuitem">Undergraduate</a>
                        </li>
                        <li class="dropdown-item">
                            <a href="/academics/graduate" class="nav__menu-link dropdown-item"
                                role="menuitem">Graduate</a>
                        </li>
                        <li class="dropdown-item">
                            <a href="/academics/schools" class="nav__menu-link dropdown-item"
                                role="menuitem">Schools</a>
                        </li>
                        <div class="dropdown-divider"></div>
                        <li class="dropdown-item">
                            <a href="/academics/global-initiatives"
                                class="nav__menu-link dropdown-item" role="menuitem">Global
                                Initiatives</a>
                        </li>
                        <li class="dropdown-item">
                            <a href="/academics/global-initiatives"
                        ...
                        <li class="dropdown-item">
                            <a href="/academics/interdisciplinary"
                                class="nav__menu-link dropdown-item"
                                role="menuitem">Interdisciplinary</a>
                        </li>
                        <li class="dropdown-item">
                            <a href="/academics/online-learning"
                                class="nav__menu-link dropdown-item" role="menuitem">Online
                                Learning</a>
                        </li>
                        <div class="dropdown-divider"></div>
                        <li class="dropdown-item">
                            <a href="/academics/off-campus-learning"
                                class="nav__menu-link dropdown-item" role="menuitem">Off-campus
                                Learning</a>
                        </li>
                        <li class="dropdown-item">
                            <a href="https://www.library.upenn.edu/"
                                class="nav__menu-link dropdown-item" role="menuitem">Libraries</a>
                        </li>
                    </ul>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="#">ADMISSION &amp; AID</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li class="dropdown-item">
                            <a href="#" class="nav__menu-link dropdown-item"
                                role="menuitem">Research
                                Enterprise</a>
                        </li>
                        <div class="dropdown-divider"></div>
                        <li class="dropdown-item">
                            <a href="/research-and-innovation/research-news"
                                class="nav__menu-link dropdown-item" role="menuitem">Research
                                News</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu3">
                        <li class="dropdown-item">
                            <a href="#" class="nav__menu-link dropdown-item" role="menuitem">Arts
                                &amp; Culture</a>
                        </li>
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="#" class="nav__menu-link dropdown-item">Community
                                Involvement</a>
                            <ul class="dropdown-menu">
                                <li class="dropdown-item">
                                    <a tabindex="-1" href="#"
                                        class="nav__menu-link dropdown-item">Penn
                                        &amp; Philadelphia</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown-item">
                            <a href="#" class="nav__menu- dropdown-item"
                                role="menuitem">Diversity</a>
                        </li>
                        <li class="dropdown-item">
                            <a href="#" class="nav__menu- dropdown-item" role="menuitem">Groups
                                &amp;
                                Organizations</a>
                        </li>
                        <li class="dropdown-item">
                            <a href="#" class="nav__menu- dropdown-item" role="menuitem">Housing
                                &amp;
                                Dining</a>
                        </li>
                        <li class="dropdown-item">
                            <a href="#" class="nav__menu- dropdown-item" role="menuitem">Health
                                &amp;
                                Wellness</a>
                        </li>
                        <li class="dropdown-submenu">
                            <a href="/life-at-penn/safety" class="nav__menu- dropdown-item"
                                role="menuitem">Safety &amp; Security</a>
                            <ul class="dropdown-menu">
                                <li class="dropdown-item">
                                    <a href="#" class="nav__menu- dropdown-item"
                                        role="menuitem">Emergency
                                        Contacts</a>
                                </li>
                                <li class="dropdown-item">
                                    <a href="#" class="nav__menu- dropdown-item"
                ...
                <li class="nav-item dropleft">
                    ...
                    <ul class="nav__menu nav__menu--level-1 dropdown-menu" role="none">
                        <li class="nav__menu-item" role="none">
                            <a href="/about/welcome" class="nav__menu-link dropdown-item"
                                role="menuitem">Introduction to
                                Penn</a>

                        </li>
                        <li class="nav__menu-item" role="none">
                            <a href="/about/history" class="nav__menu-link dropdown-item"
                                role="menuitem">History</a>

                        </li>
                        <li class="nav__menu-item" role="none">
                            <a href="/about/facts" class="nav__menu-link dropdown-item"
                                role="menuitem">Facts</a>

                        </li>
                        <li class="nav__menu-item" role="none">
                            <a href="/about/communications" class="nav__menu-link dropdown-item"
                                role="menuitem">News,
                                Media, &amp; Communication Services</a>

                        </li>
                        <li class="nav__menu-item" role="none">
                            <a href="/about/sustainability" class="nav__menu-link dropdown-item"
                                role="menuitem">Sustainability</a>

                        </li>
                        <li class="nav__menu-item" role="none">
                            <a href="/about/faq" class="nav__menu-link dropdown-item"
                                role="menuitem">FAQ</a>

                        </li>
                        <li class="nav__menu-item" role="none">
                            <a href="https://president.upenn.edu/"
                                class="nav__menu-link dropdown-item" role="menuitem">Penn’s
                                President, Liz Magill</a>

                        </li>
                        <li class="nav__menu-item" role="none">
                            <a href="/about/trustees-and-administration"
                                class="nav__menu-link dropdown-item" role="menuitem">Trustees &amp;
                                Administration</a>

                        </li>
                        <li class="nav__menu-item" role="none">
                            <a href="/about/policies" class="nav__menu-link dropdown-item"
                                role="menuitem">Policies</a>
