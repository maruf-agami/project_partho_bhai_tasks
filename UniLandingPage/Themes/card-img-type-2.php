    ...
    <div class="d-flex align-items-center">
        <div style="max-width: 95%;"><span><br><span style="color: rgb(255, 255, 255);">FEATURED
            ...
            <button class="btn btn-outline-light" type="button"
                style="border-radius: 38px;padding: 20px 58px;margin-bottom: 50px;">READ
                NOW</button>
        </div>
    </div>
    <div class="d-flex align-items-center" style="max-width: 95%;"><img
            src="https://www.upenn.edu/sites/default/files/styles/card_3x2/public/2022-03/PGS%20Galapagos.jpeg?h=6de74bd6&amp;itok=_aTlrBii"
            style="width: 100%;"></div>
</div>